<?php
/**
 * Elizabeth Coop functions and definitions
 *
...
if ( ! function_exists( 'elizabethcoop_setup' ) ) :
	/**
	 ...
	 */
	function elizabethcoop_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Elizabeth Coop, use a find and replace
		 * to change 'elizabethcoop' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'elizabethcoop', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'elizabethcoop' ),
		) );
 ...
 */
function elizabethcoop_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'elizabethcoop_content_width', 640 );
}
add_action( 'after_setup_theme', 'elizabethcoop_content_width', 0 );
...
function elizabethcoop_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Section', 'elizabethcoop' ),
		'id'            => 'footer-section',
		'description'   => esc_html__( 'Add widgets here.', 'elizabethcoop' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
...
add_action( 'widgets_init', 'elizabethcoop_widgets_init' );
